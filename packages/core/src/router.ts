...
import type {Resource, Route, RoutePathParams, RouteProperties} from "./resource";
    ...
    ? Prettify<
        {
          ...
          method: M;
          contentType: CT;
        } & (PP extends z.ZodType<infer O extends RoutePathParams> ? {params: O} : {}) &
...
type RouteImplementation<R extends Route> = (args: RouteRequest<R>) => Promise<RouteResponse<R>>;
